...
public class TradeOrder implements Serializable {
    ...
    public TradeOrder(String orderId, Integer userId, String orderStatus, String payStatus, String shippngStatus, String address, String consignee, Integer goodsId, Integer goodsNumber, BigDecimal goodsPrice, BigDecimal goodsAmount, BigDecimal shippingFee, BigDecimal orderAmount, String couponId, BigDecimal couponPaid, BigDecimal moneyPaid, BigDecimal payAmount, BigDecimal addTime, Date confirmTime, Date payTime) {
        this.orderId = orderId;
        this.userId = userId;
        this.orderStatus = orderStatus;
        this.payStatus = payStatus;
        this.shippngStatus = shippngStatus;
    ...
    public String getShippngStatus() {
        return shippngStatus;
    }

    public void setShippngStatus(String shippngStatus) {
        this.shippngStatus = shippngStatus == null ? null : shippngStatus.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", shippngStatus=").append(shippngStatus);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getOrderId() == null ? other.getOrderId() == null : this.getOrderId().equals(other.getOrderId()))
            ...
            && (this.getShippngStatus() == null ? other.getShippngStatus() == null : this.getShippngStatus().equals(other.getShippngStatus()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShippngStatus() == null) ? 0 : getShippngStatus().hashCode());
